                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card card-cascade narrower">
                            ...
                            <div class="view overlay hm-white-slight">
                                <img src="<?php if(isset($_SESSION['new_name'])){if(file_exists($_SESSION['new_name'])){ echo $_SESSION['new_name']; }}else{ echo './images/product/no.png'; } ?>" width="400" class="img-fluid" alt="">
                            </div>
                            <!--/.Card image-->
                            ...
                            <div class="card-block text-xs-center">
                                <!--Category & Title-->
                                <h5><?php echo $_SESSION['mk_name'] ?></h5>
                                <h4 class="card-title"><strong><?php echo $_SESSION['pl_name'] ?></strong></h4>

                                <!--Description-->
                                <p class="card-text">バーコード　<?php echo $_SESSION['jan'] ?><br>
                                    バーコードの分類　<?php echo $_SESSION['class'] == 0 ? 'ユニークなコード' : '既成のコード' ?>
                                </p>

                                <!--Card footer-->
                                <div class="card-footer">
                                    <span class="left">
                                        通常販売価格　<?php echo $_SESSION['price'] != '' ? $_SESSION['price'].' 円' : '設定なし' ?></span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn btn-cyan waves-effect waves-light">登録する</button>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-elegant waves-effect waves-light" href="./pl_rgt_in.php">変更する</a>
                                </div>
                            </div>
                        </div>
                    </div>
