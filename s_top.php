                ...
                <ul class="collapsible collapsible-accordion" style="color: gray;">
                    <li><a class="collapsible-header waves-effect arrow-r" style="color: gray;">・ マイページ</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="#" class="waves-effect" style="color: gray;">　店舗情報　編集</a>
                                </li>
                                <li><a href="#" class="waves-effect" style="color: gray;">　商品　登録</a>
                                </li>
                                <li><a href="#" class="waves-effect" style="color: gray;">　商品　掲載</a>
                                </li>
                                <li><a href="#" class="waves-effect" style="color: gray;">　履歴</a>
                                </li>
                            </ul>
                        </div>
                    </li>
