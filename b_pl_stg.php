...
if (isset($_POST['n_name'])) {
    ...
    if($_POST['n_name'] != ''){
        set_bpl(DB_HOST,DB_USER,DB_PASS,DB,$_POST['n_name'],$_POST['intro'],$_SESSION['user_id']);
        ...
        <div class="container-fluid text-xs-center" style="height: 800px;">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="md-form">
                        <input type="text" id="form1" name="n_name" value="<?php echo $row['n_name'] ?>">
                        <label for="form1" class="">ニックネーム</label>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="md-form">
                        <input type="text" id="form2" name="intro" value="<?php echo $row['introduction'] ?>">
                        <label for="form2" class="">自己紹介</label>
                    </div>
